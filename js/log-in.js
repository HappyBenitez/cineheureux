...
$(document).ready(function() {
  setTimeout(function firstVideo() {
      $('#video-placeholder').attr( "src", "https://www.youtube.com/embed/UzFZR2dRsSY?si=P0EZlU0WpQ_j51BI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" );
      setTimeout(function secondVideo() {
          $('#video-placeholder').attr( "src", "https://www.youtube.com/embed/Fz5XQ3bslPM?si=0ZOISNOApoFodrtu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin");
      }, 69000);
  }, 65000);
});
